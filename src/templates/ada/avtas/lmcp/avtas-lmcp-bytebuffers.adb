...
package body AVTAS.LMCP.ByteBuffers is
   ...
   begin
      Insert_UInt16 (Value'Length, This.Content, Start => This.Position);
      This.Position := This.Position + 2;
      ...
      This.Total_Bytes_Used := This.Total_Bytes_Used + 2 + Value'Length;
   end Put_String;
   ...
   begin
      Result := MemCopy (Destination => This.Content (This.Position)'Address,
                         ...
                         Count       => Storage_Count (Value'Length));
      This.Position := This.Position + Value'Length;
      This.Total_Bytes_Used := This.Total_Bytes_Used + Value'Length;
   end Put_Raw_Bytes;
